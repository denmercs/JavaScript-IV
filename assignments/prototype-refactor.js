...
//   }
  ...
  class Humanoid extends CharacterStats{
      constructor(childAttrs) {
          super(childAttrs);
          this.team = childAttrs.team;
          this.weapons = childAttrs.weapons;
          this.language = childAttrs.language;
      }
  ...
  */
  ...
  // Test you work by un-commenting these 3 objects and the list of console logs below:
    ...
    class Villain extends Humanoid {
        constructor(childAttrs) {
            super(childAttrs);
            this.state = childAttrs.state;
            this.weaponDamage = childAttrs.weaponDamage;
            this.role = childAttrs.role;
        }
    }
